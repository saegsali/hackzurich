...
headers = {
    'Authorization': 'Bearer OPKfayNv3jwMHWM5cDosGvbTUQTbCbf5gppZJoMJISISsA4vwOu5TVjDTprOGOx2',
...
response = requests.post('https://api.datawrapper.de/v3/charts/vc65b/data', headers=headers, data=data)
...
response = requests.post('https://api.datawrapper.de/v3/charts/vc65b', headers=headers, data=data)

headers = {
    'Authorization': 'Bearer OPKfayNv3jwMHWM5cDosGvbTUQTbCbf5gppZJoMJISISsA4vwOu5TVjDTprOGOx2',
}

response = requests.get('https://api.datawrapper.de/charts/vc65b/publish', headers=headers)