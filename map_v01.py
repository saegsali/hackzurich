...
response = requests.post('https://api.datawrapper.de/v3/charts/RWBu7/data', headers=headers, data=data)
...
response = requests.post('https://api.datawrapper.de/v3/charts/RWBu7', headers=headers, data=data)
...
response = requests.get('https://api.datawrapper.de/charts/RWBu7/publish', headers=headers)